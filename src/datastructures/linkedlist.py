...
class LinkedList(ILinkedList[T]):
    ...
    @staticmethod
    def from_sequence(sequence: Sequence[T]) -> LinkedList[T]:
    ...
    def __str__(self) -> str:
        raise NotImplementedError("LinkedList.__str__ is not implemented")

    def __repr__(self) -> str:
        raise NotImplementedError("LinkedList.__repr__ is not implemented")
